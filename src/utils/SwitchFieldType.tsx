...
function switchFieldType(
  ...
  const dragEndField = () => {
    ...
    for (let i = 0; i < targetQuestion.fields.length; i++) {
      const field = targetQuestion.fields[i];
...
export default switchFieldType;